...
def unet(input_size, n_output_channels, dropout_value, n_convolutions_per_block, optim, lr, pretrained_weights = None):
    ...
    deconv256 = up_conv_block(256, conv512, conv256, n_convolutions_per_block, inner_activation, kernel_value, batch_norm, dropout_value)
    # x128 layers going up
    deconv128 = up_conv_block(128, conv256, conv128, n_convolutions_per_block, inner_activation, kernel_value, batch_norm, dropout_value)
    # x64 layers going up
    deconv64 = up_conv_block(64, conv128, conv64, n_convolutions_per_block, inner_activation, kernel_value, batch_norm, dropout_value)
    '''
    # x32 layers going up
    deconv32 = up_conv_block(32, conv64, conv32, n_convolutions_per_block, inner_activation, kernel_value, batch_norm, dropout_value)
    # x16 layers going up
    deconv16 = up_conv_block(16, deconv32, conv16, n_convolutions_per_block, inner_activation, kernel_value, batch_norm, dropout_value)
    # Output
    convFIN = Conv3D(n_output_channels, kernel_size = 1, activation = final_activation)(deconv16)
